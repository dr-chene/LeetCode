 ...
 */
public class ApiResultJsonDeserializer implements JsonDeserializer<NetworkBoundResource.ApiResponse<?>> {

    @Override
    public NetworkBoundResource.ApiResponse<?> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        NetworkBoundResource.ApiResponse<?> response = new NetworkBoundResource.ApiResponse<>();
